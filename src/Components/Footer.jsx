                ...
                <div className="footer-links">
                    <div className='footer-logo'>
                        <Link to='/' className='footer-logo-text-link'>
                            <h2 className='footer-logo-text'>Asia Cargo</h2>
                        </Link>
                    </div>
                    <div className="footer-links-contacts">
                        ...
                        <div onClick={() => openInNewTab('https://www.instagram.com/asiacargo_kg/')} className="footer-links-contacts-link">
                            <InstagramOutlined style={{color: '#E933B3', fontSize: '22px'}} />
                            <span className='footer-links-contacts-text'>@asiacargo_kg</span>
                        </div>
                    </div>
                </div>
                <div className="footer-rights">
                    <h3 className='footer-rights-text'>© 2024 Asia Cargo. Все права защищены.</h3>
                </div>
            </footer>
        </div>
    </div>
